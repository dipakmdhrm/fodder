...
- **`core/src/ipc.rs`** - round-trip of every `IpcMessage` variant (incl. `SetAutostart`, `RenameFeed`) over `tokio::io::duplex`, partial-frame reassembly, and clean-EOF -> `None`.
